...
def make_meta(meta_file,
              ...
              work_frame=[452-135, -125, 53, 180, 0, 180],  # 452, -125
              linear_speed=10,
              angular_speed=10,
              num_frames=1,
              tap_move=[[0, 0, 6, 0, 0, 0], [
                  50, 0, 6, 0, 0, 0], [50, 0, 0, 0, 0, 0]],  # 0, 0, 6, 0, 0, 0
              poses_rng=[[-5, 0, -3, -15, -15, -45], [5, 0, 0, 15, 15, 45]],
              obj_poses=[[0, y, 0, 0, 0, 0] for y in range(0, 550, 50)],
              num_poses=11,
              num_trials=100,
              ):

    obj_poses[1] = [0, 50, 1, 0, 0, 0]
    obj_poses[3] = [0, 150, 1, 0, 0, 0]
