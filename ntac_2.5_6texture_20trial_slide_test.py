...
def make_meta(meta_file,
              ...
              work_frame=[452, 75, 53, 180, 0, 180],
              linear_speed=10,
              angular_speed=10,
              num_frames=1,
              ...
              obj_poses=[[0, ang, 0, 0, 0, 0] for ang in range(0, 300, 50)],
              num_poses=6,
              num_trials=20,
              ):
...
def make_sensor():
    return TacTip_neuro(port=40133)
        ...
        for r in range(num_trials):
            ...
            for pose in obj_poses:
                ...
                print("Trial " + str(r+1) + "/" + str(num_trials) +
                      "- Tap " + str(obj_idx+1) + "/" + str(len(obj_poses)))
                robot.coord_frame = base_frame
                ...
                # Save data
                pickle_out = open(os.path.join(data_dir, 'SingleTap_run_' +
                                               str(r) + '_orientation_' + str(obj_idx) + '.pickle'), 'wb')
